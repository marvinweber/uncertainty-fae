...
class LitClavicleDeepEnsemble(UncertaintyAwareModel, TrainLoadMixin):

    BASE_MODEL_CLASS = LitClavicleMCDropout  # We won't use the dropout during inference
    ...
    def evaluate_dataset(
        ...
        if self.undo_boneage_rescale:
            n_predictions = undo_clavicle_age_rescale(n_predictions)
...
class LitClavicleVarianceNetDeepEnsemble(LitClavicleDeepEnsemble):

    BASE_MODEL_CLASS = LitClavicleVarianceNetMCDropout  # We won't use the dropout during inference
